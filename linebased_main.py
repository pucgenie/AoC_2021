...
def linebased_main(puzzle_name, do_it, example_data=None, data_parser=None, data_url=None,):
	import argparse
	parser = argparse.ArgumentParser(description=f"Advent of Code 2021, {puzzle_name}")
